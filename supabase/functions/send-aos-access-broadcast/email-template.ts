export const AOS_BROADCAST_SUBJECT = "Your ALP Handbook now includes AOS.";
export const AOS_BROADCAST_PREVIEW =
  "AOS — the operating system that runs the doctrine day-to-day — is now included with your handbook purchase.";

export const AOS_BROADCAST_HTML = `<!doctype html>
<html>
  <head>
    <meta charset="utf-8">
    ...
    <title>Your ALP Handbook now includes AOS.</title>
  </head>
            ...
            <tr>
              <td style="padding:46px 56px 48px;background:#fbf7ef;">
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                  <tr>
                    <td style="padding:0 0 18px;">
                      <p style="margin:0 0 8px;font-family:Arial,Helvetica,sans-serif;font-size:17px;line-height:1.35;color:#111111;font-weight:700;">
                        The handbook gave you the doctrine.
                      </p>
                      <p style="margin:0;font-family:Arial,Helvetica,sans-serif;font-size:15px;line-height:1.55;color:#4f4a42;">
                        AOS is the operating system that runs it — Vision, People, Data, Issues, Process, and Traction, structured for a contractor's week.
                      </p>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td style="padding:18px 0 0;border-top:1px solid #d4ccbe;">
                      ...
                      <p style="margin:0;font-family:Arial,Helvetica,sans-serif;font-size:15px;line-height:1.55;color:#4f4a42;">
                        Stop reading. Start running. AOS is where the chapters become a weekly rhythm.
                      </p>
                    </td>
                  </tr>
                </table>
                ...
                <p style="margin:0 0 20px;font-family:Arial,Helvetica,sans-serif;font-size:11px;line-height:1.7;letter-spacing:3px;text-transform:uppercase;color:#111111;">
                  <span style="color:#d95f22;font-weight:700;">Bonus Access</span><br>
                  Sign up with your handbook purchase email.
                </p>
                <p style="margin:0;">
                  <a href="https://alpos.alpcontractorcircle.com/signup" style="display:inline-block;background:#111111;color:#fbf7ef;text-decoration:none;padding:15px 22px;font-family:Arial,Helvetica,sans-serif;font-size:12px;letter-spacing:2px;text-transform:uppercase;font-weight:700;">
                    Activate AOS Access
                  </a>
                </p>
                <div style="height:34px;line-height:34px;">&nbsp;</div>
